...
## ✨ Key Features
EventHub is packed with features to create a seamless event experience:
...
<div align="center">
  <img src="frontend/public/eventhub-readme-images/event-page.png" alt="Screenshot of the main event management page in EventHub" width="600" />
...
EventHub is designed using a **microservice architecture** to ensure scalability, maintainability, and independent deployment of services. An **API Gateway** acts as a single entry point for all client requests, routing them to the appropriate downstream service.
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/qtt7715-ux/Eventhub](https://github.com/qtt7715-ux/Eventhub)
    cd eventhub
    ```
...
    <tr>
      <td align="center">
        <img src="frontend/public/eventhub-readme-images/admin-dashboard.png" alt="Admin Dashboard for User Management" width="250" /><br>
        <em>Admin Dashboard</em>
      </td>
      <td align="center">
        <img src="frontend/public/eventhub-readme-images/organizer-dashboard.png" alt="Organizer Dashboard for Event Management" width="250" /><br>
        <em>Organizer Dashboard</em>
      </td>
      <td align="center">
        <img src="frontend/public/eventhub-readme-images/participant-home.png" alt="Participant Home Page showing available events" width="250" /><br>
